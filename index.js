...
// TODO: Implement a function that clears all the existing content
...
// Value is a string representing an image URL
function showMeme() {
    const randomMemeUrl = getRandomData("memes");
    const randomMeme = document.querySelector("#meme-container")
    ...
    randomMeme.appendChild(newImage)
}

// TODO:
// - Show a random joke in the correct location
// - Never show more than one joke a time
function showJoke() {
...
function showRiddle() {
    ...
    riddleContainer.appendChild(questionElement);
    riddleContainer.appendChild(answerElement);

}

//TODO: unhide the riddles answers
// - if there is no riddle shown, alert the user that there is no riddle
// - if there is a riddle show and an answer shown, alert the user that the answer is already revealed
// - If there is a riddle shown but no answer, unhide the anser!

function revealAnswer() {
    const riddleContent = document.querySelector("#riddle");
